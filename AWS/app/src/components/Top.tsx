                    ...
                    <div className="modal-content" onClick={(e) => e.stopPropagation()} >
                        <div className="modal-scroll">
                            ...
                            <ol>
                                ...
                                <li id='error-info'>
                                    Temporary Measure: once logged into LASP VPN, open a new tab and enter <span>'https://10.247.28.195:3000'</span>. Click <span>'Advanced'</span> or <span>'show details'</span>, and then choose to proceed. Then restart the application by opening a new window or refreshing. This issue is a result of the SSL not yet being configured, and is required until it has been configured in order for your browser to trust the application domain. This will be resolved shortly and this step will then be removed.
                                </li>
                            </ol>
                            <ul>
