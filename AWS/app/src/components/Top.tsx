...
/**
 * Top component that serves as the header for the Dust Data Digger application.
 * 
 * This component contains a button to open an information modal and displays the title of the application.
 * 
 * The information modal provides users with detailed instructions on how to use the application, along with troubleshooting steps and future updates.
 * 
 * @component
 * @returns {JSX.Element} The rendered Top component, including the modal and title.
 */
const Top: React.FC = () => {
  /** State to handle the visibility of the information modal. */
  const [infoModalOpen, setInfoModalOpen] = useState(false);

  /**
   * Handles the click event on the 'Info' button, showing the modal.
   */
          ...
          <div className="modal-overlay">
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              <div className="modal-scroll">
                ...
                <p>
                  This Application interfaces with the IMPACT Lab AWS server and plots data shot by the lab's Pelletron Accelerator. 
                  Any dust data stored in our server can be plotted as a saveable .png and downloaded as a .csv file using this application.
                </p>
                <h2>Instructions:</h2>
                <ol>
                    <li>
