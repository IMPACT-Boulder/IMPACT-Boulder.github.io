  ...
  render() {
    if (this.state.hasError) {
      return <div id='error-boundary'>
        ...
        <h4>Secure Scoket Layer not yet configured. Open a new tab and enter 'https://10.247.28.195:3000'. Click Advanced, and choose to proceed. This issue is temporary. </h4>
        </div>;
    }
